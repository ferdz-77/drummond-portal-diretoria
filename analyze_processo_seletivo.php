...
try {
    ...
    echo "<h1>📊 Análise Portal Processo Seletivo</h1>";
    ...
    $columns_sql = "SHOW COLUMNS FROM chamados LIKE '%categoria%' OR SHOW COLUMNS FROM chamados LIKE '%tipo%' OR SHOW COLUMNS FROM chamados LIKE '%servico%'";
    $result = $conn_processo->query("SHOW COLUMNS FROM chamados");
    $available_columns = [];
    ...
    $servicos_data = getServicosSolicitadosProcessoSeletivo();
    echo "<pre>";
